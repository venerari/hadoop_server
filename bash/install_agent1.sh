...
./agent/config.sh --unattended --url https://dev.azure.com/venerayan/ --auth pat --token utzkht7sqh43jk3q4tzf3rdvypgruib3tsyvwjkveglszkgic7ha --pool Default --agent azure1 --work ./_work 
nohup ./agent/run.sh &
# git2
